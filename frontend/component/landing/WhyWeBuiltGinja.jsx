...
export default function WhyWeBuiltGinja() {
  ...
  return (
    <section className="bg-gray-950 text-white">
      ...
      <div className="py-16 sm:py-24 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 relative z-10">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <p className="text-xl sm:text-2xl font-semibold text-white">The world is louder than ever.</p>
            ...
            <p>But productivity apps today are built for tasks — not for humans.</p>

            <p className="border-l-4 border-[#E2561B] pl-4 sm:pl-6 text-white font-medium">
              We built Ginja because we saw a deeper problem:<br />
            ...
            <p className="text-white font-semibold">Ginja was built as a response to that.</p>

            <div className="bg-gray-900/60 border border-gray-800 rounded-2xl p-6 sm:p-8">
              <p className="text-white font-semibold mb-3">A space to:</p>
            ...
            <p className="text-center text-white text-lg sm:text-xl font-semibold pt-4">
      ...
      {/* ── Why the Name "Ginja"? ── */}
      <div className="py-16 sm:py-24 bg-gray-900/50 relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 relative z-10">
          ...
          <motion.div
            className="space-y-6 text-gray-300 text-base sm:text-lg leading-relaxed text-center"
            initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
            transition={{ duration: 0.8, delay: 0.2 }}
            viewport={{ once: true }}
          >
            <p>
              <span className="text-white font-semibold">&ldquo;Ginja&rdquo;</span> is a common Nigerian slang that means:<br />
            ...
            <p className="text-white font-semibold text-lg sm:text-xl">Ginja is that spark.</p>

            <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-8 text-white font-medium pt-2">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {ginjaForCards.map((card, i) => (
              <motion.div
                key={i}
                className="bg-gray-900/60 border border-gray-800 rounded-2xl p-5 sm:p-6 hover:border-[#E2561B]/40 transition-all duration-300"
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
          ...
          <motion.p
            className="text-center text-gray-300 text-base sm:text-lg mt-8 sm:mt-10"
            initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
          ...
          >
            ...
            <span className="text-white font-semibold">It&apos;s a thinking space.</span>
          </motion.p>
        </div>
      </div>
      ...
      <div className="py-16 sm:py-24 bg-gray-900/50 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 relative z-10">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h3 className="text-xl sm:text-2xl font-bold text-white mb-1">Emmanuel Onwubuya</h3>
            ...
            <div className="space-y-5 text-gray-300 text-sm sm:text-base leading-relaxed">
              ...
              <p className="text-white font-semibold">Ginja was born from that realization.</p>
              <p>
              ...
              <div className="bg-gray-800/50 border border-gray-700 rounded-xl p-5 mt-4">
                <p className="text-white font-semibold mb-1">His mission:</p>
