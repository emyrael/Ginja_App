  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900 p-6 sm:p-12">
      ...
      <main className="max-w-2xl mx-auto">
        ...
        <p className="mb-6 text-gray-700">We are sorry to see you go. Use the form below to request permanent deletion of your account and associated data.</p>
        ...
        {!requested ? (
          ...
          >
            ...
            <div>
              ...
              <textarea className="mt-1 block w-full rounded-md border-gray-300 shadow-sm p-2" rows={4} />
            </div>
          ...
          <div className="bg-white rounded-md p-6 shadow">
            ...
            <p className="text-gray-700">We&apos;ve received your request. Our support team will verify and complete the deletion within 7 business days. You&apos;ll receive a confirmation email.</p>
          </div>
        )}
      </main>
    </div>
