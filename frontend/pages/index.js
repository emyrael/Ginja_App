...
export default function Home() {
  return (
    <>
      <Head>
        <title>Ginja - Stay Gingered. Stay Organized.</title>
        ...
        <meta property="og:title" content="Ginja - Stay Gingered. Stay Organized." />
        ...
        <meta name="twitter:title" content="Ginja - Stay Gingered. Stay Organized." />
