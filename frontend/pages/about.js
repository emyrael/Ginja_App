      ...
      <main className="min-h-screen bg-white dark:bg-gray-950 text-gray-900 dark:text-white">
        ...
        <section className="pb-16 sm:pb-24">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 space-y-8">
            ...
            >
              <div className="space-y-6 text-gray-600 dark:text-gray-300 text-base sm:text-lg leading-relaxed">
                <p>
                ...
                <p className="text-gray-900 dark:text-white text-xl sm:text-2xl font-bold text-center py-2">Human overwhelm.</p>
                ...
                <p className="text-gray-900 dark:text-white font-semibold">That insight led to two parallel missions.</p>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-2">AIXelar</h2>
              <p className="text-[#E2561B] font-medium text-sm sm:text-base mb-6">AI Automation &amp; Intelligent Systems</p>

              <div className="space-y-6 text-gray-600 dark:text-gray-300 text-base sm:text-lg leading-relaxed">
                <p>
                  Emmanuel is the founder of <strong className="text-gray-900 dark:text-white">AIXelar</strong>, an AI automation agency helping
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-6">Why Ginja Exists</h2>
              ...
              <div className="space-y-6 text-gray-600 dark:text-gray-300 text-base sm:text-lg leading-relaxed">
                ...
                <p>
                  ...
                  Very few optimize <span className="text-gray-900 dark:text-white font-semibold">mental space</span>.
                </p>

                <p className="text-gray-900 dark:text-white font-semibold">Ginja was built as a human-first productivity system.</p>
                ...
                <div className="bg-gray-200/60 dark:bg-gray-800/50 border border-gray-300 dark:border-gray-700 rounded-xl p-6 text-center">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-6">Connect With Emmanuel</h2>
            ...
            >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 border border-gray-300 dark:border-gray-700 text-gray-900 dark:text-white font-bold px-5 py-3 rounded-full hover:border-[#E2561B]/60 hover:shadow-lg transition-all duration-300 hover:scale-105 text-sm sm:text-base"
              >
                Connect on LinkedIn
              </a>
              <a
        ...
        {/* Simple Footer */}
        <footer className="border-t border-gray-200/50 dark:border-gray-800/50 py-6 text-center text-gray-500 text-sm">
