      ...
      <main className="min-h-screen bg-[var(--bg-primary)] text-[#1F1C17]">
        <header className="sticky top-0 z-40 border-b border-[#E5DED3] bg-[#F8F5EE]/95 backdrop-blur-md">
          <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-4 sm:px-6">
            ...
            <Link href="/" className="text-sm font-medium text-[#6A645A] hover:text-[#1E1B17]">
              ← Back to Home
            </Link>
          </div>
        </header>
        ...
        <section className="px-4 pb-10 pt-12 sm:px-6 sm:pt-16">
          <div className="mx-auto max-w-5xl rounded-[2rem] border border-[#E5DED3] bg-white px-6 py-10 shadow-[0_16px_44px_rgba(34,30,24,0.08)] sm:px-10 sm:py-14">
            ...
            <p className="mt-6 max-w-3xl text-base leading-relaxed text-[#5F5A51] sm:text-lg">
              Ginja is a productivity app for people who feel mentally overloaded by traditional task tools. It helps you clear
              mental clutter, organize what matters, and stay consistent without overwhelm.
            </p>
            <div className="mt-8 grid gap-3 sm:grid-cols-2">
              <div className="rounded-2xl bg-[#F8F4ED] px-4 py-3 text-sm font-medium">Brain Dump to clear next steps</div>
              <div className="rounded-2xl bg-[#F8F4ED] px-4 py-3 text-sm font-medium">Smart reminders with better timing</div>
              <div className="rounded-2xl bg-[#EEF5E8] px-4 py-3 text-sm font-medium">Weekly Focus for intentional planning</div>
              <div className="rounded-2xl bg-[#EEF5E8] px-4 py-3 text-sm font-medium">Circle for shared accountability</div>
            </div>
          </div>
        </section>

        <section className="px-4 pb-10 sm:px-6">
          <div className="mx-auto max-w-5xl rounded-[2rem] border border-[#E5DED3] bg-[#FAF8F3] px-6 py-10 sm:px-10">
            <h2 className="text-2xl font-semibold sm:text-3xl">Why Ginja exists</h2>
            <p className="mt-4 text-base leading-relaxed text-[#5F5A51] sm:text-lg">
        ...
        <section className="px-4 pb-10 sm:px-6">
          <div className="mx-auto grid max-w-5xl gap-4 sm:grid-cols-3">
            {principles.map((item) => (
              <article key={item.title} className="rounded-3xl border border-[#E5DED3] bg-white p-6 shadow-[0_10px_24px_rgba(36,31,24,0.06)]">
                <h3 className="text-lg font-semibold">{item.title}</h3>
                <p className="mt-3 text-sm leading-relaxed text-[#5F5A51]">{item.body}</p>
              </article>
            ))}
          </div>
        </section>
        ...
        <section className="px-4 pb-10 sm:px-6">
          <div className="mx-auto max-w-5xl rounded-[2rem] border border-[#E5DED3] bg-white px-6 py-10 sm:px-10">
        ...
        <section className="px-4 pb-16 sm:px-6 sm:pb-20">
          <div className="mx-auto max-w-5xl rounded-[2rem] border border-[#DCE8D5] bg-[#F1F8EC] px-6 py-10 sm:px-10">
            <p className="text-xs font-semibold uppercase tracking-[0.14em] text-[#4D7A47]">Founder</p>
            <h2 className="mt-3 text-2xl font-semibold sm:text-3xl">Built by Manuel</h2>
            <p className="mt-4 text-base leading-relaxed text-[#486047] sm:text-lg">
            ...
            <div className="mt-6 grid gap-3 sm:grid-cols-2">
              <div className="rounded-2xl border border-[#CFE0C5] bg-white px-4 py-3">
                <p className="text-xs font-semibold uppercase tracking-wider text-[#6A7E64]">Interests</p>
                <p className="mt-1 text-sm text-[#456043]">Human-centered product design</p>
              </div>
              <div className="rounded-2xl border border-[#CFE0C5] bg-white px-4 py-3">
                <p className="text-xs font-semibold uppercase tracking-wider text-[#6A7E64]">Interests</p>
                <p className="mt-1 text-sm text-[#456043]">Mental clarity and wellbeing routines</p>
              </div>
              <div className="rounded-2xl border border-[#CFE0C5] bg-white px-4 py-3">
                <p className="text-xs font-semibold uppercase tracking-wider text-[#6A7E64]">Interests</p>
                <p className="mt-1 text-sm text-[#456043]">AI and adaptive product experiences</p>
              </div>
              <div className="rounded-2xl border border-[#CFE0C5] bg-white px-4 py-3">
                <p className="text-xs font-semibold uppercase tracking-wider text-[#6A7E64]">Interests</p>
                <p className="mt-1 text-sm text-[#456043]">Building tools people feel good using daily</p>
              </div>
            </div>
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <a
                ...
                className="rounded-full border border-[#C8DABA] bg-white px-5 py-2.5 text-sm font-semibold text-[#3E5B34] hover:border-[#A8C399]"
              >
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <Link
                href="/support"
                className="rounded-full border border-[#C8DABA] bg-white px-5 py-2.5 text-sm font-semibold text-[#3E5B34]"
              >
                Contact support
              </Link>
            </div>
